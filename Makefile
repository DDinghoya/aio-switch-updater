...
$(BUILD): $(ROMFS)
	...
	@cp $(CURDIR)/output/kefir-updater.nro /mnt/d/git/dev/_kefir/kefir/switch/Kefir-updater/kefir-updater.nro
...
copy:
	@cp $(CURDIR)/output/kefir-updater.nro /mnt/d/git/dev/_kefir/kefir/switch/kefir-updater/kefir-updater.nro
	@cp $(CURDIR)/../TegraExplorer/output/TegraExplorer_small.bin /mnt/d/git/dev/_kefir/kefir/switch/kefir-updater/kefir-updater.bin
